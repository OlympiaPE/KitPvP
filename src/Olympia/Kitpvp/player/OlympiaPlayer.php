...
class OlympiaPlayer extends Player
{
    ...
    private PlayerCooldowns $cooldowns;
    ...
    public function __construct(Server $server, NetworkSession $session, PlayerInfo $playerInfo, bool $authenticated, Location $spawnLocation, ?CompoundTag $namedtag)
    {
        ...
        $this->cooldowns = new PlayerCooldowns($this);
    ...
    public function getProperties(): PlayerProperties
    {
    ...
    public function getCooldowns(): PlayerCooldowns
    {
    ...
    private function updateCosmeticsCategories(): void
    {
        ...
        // MISSING CATEGORIES
        $categories = CosmeticsManager::getInstance()->getCategoriesName();
        ...
        // MISSING COSMETICS
        $categoriesCosmetics = CosmeticsManager::getInstance()->getCategories();
    ...
    {
        return
            strtolower($this->getWorld()->getDisplayName()) !== strtolower(ConfigManager::getInstance()->getNested("spawn.world")) ||
            $this->getPosition()->getFloorY() < ConfigManager::getInstance()->getNested("spawn.safe-height");
    }
