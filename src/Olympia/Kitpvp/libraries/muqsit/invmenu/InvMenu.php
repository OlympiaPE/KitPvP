...
namespace Olympia\Kitpvp\libraries\muqsit\invmenu;

use Closure;
use Olympia\Kitpvp\libraries\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
use Olympia\Kitpvp\libraries\muqsit\invmenu\session\InvMenuInfo;
use Olympia\Kitpvp\libraries\muqsit\invmenu\session\network\PlayerNetwork;
use Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
use Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\InvMenuTransaction;
use Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\InvMenuTransactionResult;
use Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
use Olympia\Kitpvp\libraries\muqsit\invmenu\type\InvMenuType;
use Olympia\Kitpvp\libraries\muqsit\invmenu\type\InvMenuTypeIds;
use LogicException;
...
class InvMenu implements InvMenuTypeIds{
	...
	/**
	 * @param (Closure(\Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\DeterministicInvMenuTransaction) : void)|null $listener
	 * @return Closure(\Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\InvMenuTransaction) : \Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\InvMenuTransactionResult
	 */
	...
	/**
	 * @return (Closure(\Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult)|null
	 */
	...
	/**
	 * @param (Closure(\Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\InvMenuTransaction) : \Olympia\Kitpvp\libraries\muqsit\invmenu\transaction\InvMenuTransactionResult)|null $listener
	 * @return self
	 */
