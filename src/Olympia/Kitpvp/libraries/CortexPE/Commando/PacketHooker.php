...
namespace Olympia\Kitpvp\libraries\CortexPE\Commando;

use Olympia\Kitpvp\libraries\CortexPE\Commando\exception\HookAlreadyRegistered;
use Olympia\Kitpvp\libraries\CortexPE\Commando\store\SoftEnumStore;
use Olympia\Kitpvp\libraries\CortexPE\Commando\traits\IArgumentable;
use Olympia\Kitpvp\libraries\muqsit\simplepackethandler\SimplePacketHandler;
...
class PacketHooker implements Listener {
	...
	/**
	 * @param \Olympia\Kitpvp\libraries\CortexPE\Commando\traits\IArgumentable $argumentable
	 *
	 * @return CommandOverload[]
	 */
