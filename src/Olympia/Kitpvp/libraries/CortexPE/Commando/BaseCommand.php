...
use Olympia\Kitpvp\libraries\CortexPE\Commando\constraint\BaseConstraint;
use Olympia\Kitpvp\libraries\CortexPE\Commando\exception\InvalidErrorCode;
use Olympia\Kitpvp\libraries\CortexPE\Commando\traits\ArgumentableTrait;
...
abstract class BaseCommand extends Command implements IArgumentable, IRunnable, PluginOwned {
	...
	/**
	 * @param \Olympia\Kitpvp\libraries\CortexPE\Commando\traits\ArgumentableTrait $ctx
	 * @param array             $args
	 *
	 * @return array|null
	 */
